  ...
  static TimeEntryModel? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return TimeEntryModel(
        ...
        spentOn: mapValueOfType<Object>(json, r'spentOn'),
        hours: mapValueOfType<Object>(json, r'hours'),
        ongoing: mapValueOfType<Object>(json, r'ongoing'),
