...
class RevisionModel {
  ...
  int get hashCode =>
    ...
    (formattedIdentifier == null ? 0 : formattedIdentifier!.hashCode) +
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.formattedIdentifier != null) {
      json[r'formattedIdentifier'] = this.formattedIdentifier;
    } else {
      json[r'formattedIdentifier'] = null;
    }
  ...
  static RevisionModel? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return RevisionModel(
        ...
        identifier: mapValueOfType<Object>(json, r'identifier'),
        formattedIdentifier: mapValueOfType<Object>(json, r'formattedIdentifier'),
        authorName: mapValueOfType<Object>(json, r'authorName'),
