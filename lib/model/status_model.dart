  ...
  static StatusModel? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return StatusModel(
        ...
        isDefault: mapValueOfType<Object>(json, r'isDefault'),
        isClosed: mapValueOfType<Object>(json, r'isClosed'),
        isReadonly: mapValueOfType<Object>(json, r'isReadonly'),
        defaultDoneRatio: mapValueOfType<Object>(json, r'defaultDoneRatio'),
...
class StatusModelTypeEnum {
  ...
  static const status = StatusModelTypeEnum._('Status');
...
class StatusModelTypeEnumTypeTransformer {
  ...
  Object encode(StatusModelTypeEnum data) => data.value;
