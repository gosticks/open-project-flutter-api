...
class WorkPackagesApi {
  ...
  /// * [int] id (required):
  ///   Project id
  Future<Response> availableAssigneesWithHttpInfo(int id,) async {
    // ignore: prefer_const_declarations
  ...
  /// * [int] id (required):
  ///   Project id
  Future<Object?> availableAssignees(int id,) async {
    final response = await availableAssigneesWithHttpInfo(id,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
